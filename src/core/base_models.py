...
class AbstractAdvertisement(TimeCreateUpdateModel):
    ...
    def __str__(self) -> str:
        """Получить строковое представление объявления.

        Returns:
            str: строковое представление объявления
    ...
    def publish(self, request: HttpRequest) -> None:
        ...
        Если текущий статус объявления - 'Черновик', то он меняется на 'На модерации'.
    ...
    def get_admin_url(self, request: HttpRequest) -> str:
        ...
        Returns:
            str: ссылка на экземпляр модели в админке
